      ...
      <div className="space-y-6">
        ...
        {image && (
          <div className="w-full flex justify-center">
            <img src={image} alt="Captured" className="max-h-48 rounded-lg shadow border object-contain" />
          </div>
        )}
        ...
        {loading && (
          <div className="text-center space-y-2 py-6">
            ...
            <p className="text-blue-600 font-bold">AIが詳細解析中...</p>
          </div>
        )}
